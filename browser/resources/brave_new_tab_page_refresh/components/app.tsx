...
// Lazy load LazyNewsFeed to avoid loading brave_news modules when disabled
const LazyNewsFeed = isBraveNewsEnabled
  ? React.lazy(() =>
      import('./news/lazy_news_feed').then((m) => ({
        default: m.LazyNewsFeed,
      })),
    )
  : () => null
